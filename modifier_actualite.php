...
if ($id_actualite <= 0) {
    ...
    header("Location: tableau_bord2.php");
    exit;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    /*
    | Le statut vient du bouton utilisé.
    */
    ...
    if (empty($erreurs)) {
        ...
        try {
            ...
            */
            ...
            /*
            | Si on publie une actualité qui ne
            | l'était pas encore, on lui donne
            | la date actuelle.
            */
            ...
            /*
            | Si elle repasse en brouillon,
            | on retire la date de publication.
            */
            ...
            */
            ...
            $message =
                $statut === 'publiee'
                ? "Actualité modifiée et publiée avec succès."
                : "Actualité modifiée et enregistrée comme brouillon.";
            ...
            /*
            | Si la nouvelle image a été enregistrée
            | mais que la transaction échoue,
            | on la supprime.
            */

            if (
                !empty($nouvelle_image) &&
                $destination !== null &&
            ...
            $erreurs[] =
                "Une erreur est survenue lors de la modification de l'actualité.";
...
<main class="container">
    ...
    <form
        action="modifier_actualite.php?id=<?php echo $id_actualite; ?>"
        method="POST"
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <p>
                            ...
                            Conservez ou remplacez l'image actuelle.
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-box">
                            ...
                            Si vous ne sélectionnez pas de nouvelle image,
                ...
                <div
                    ...
                    <div class="card-header">
                        ...
                        <p>
                            ...
                            Déterminez l'état de l'actualité.
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-box">
                            ...
                            n'est pas visible sur le site public.
...
document.querySelectorAll(
    ...
    button.addEventListener(
        ...
        function (event) {
            ...
            const confirmation =
                confirm(
                    'Voulez-vous enregistrer cette actualité comme publiée ?'
                );
